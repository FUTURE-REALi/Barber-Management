...
const UpcomingBookings = ({ bookings, loading, onCancel }) => {
  if (loading) return <div className="text-center text-gray-500">Loading...</div>;
  if (!bookings.length) return <div className="text-center text-gray-500">No upcoming bookings.</div>;
  return (
      ...
      {bookings.map((b) => (
        <div key={b._id} className="border rounded-lg p-4 flex flex-col md:flex-row md:items-center justify-between bg-white shadow">
          <div>
            ...
            <div className="text-gray-500 text-sm">Status: <span className="text-blue-600">Upcoming</span></div>
